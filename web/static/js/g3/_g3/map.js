...
export class Map {
    ...
    view( canvas ) {
        ...
        var that = this;
        var ratio = this.canvas.offsetWidth / this.canvas.offsetHeight;
        ...
        function onWindowResize(event) {
            var w_new = Math.min(w, window.innerWidth)
            var h_new = h / ratio
            that.canvas.style.width = w_new + "px"
            that.canvas.style.height = h_new + "px"
            that._renderer.setSize(w_new, h_new);
            that._camera.aspect = w_new / h_new;
