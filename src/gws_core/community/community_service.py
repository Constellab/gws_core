...
from .community_dto import (CommunityAgentDTO, CommunityAgentFileDTO,
                            ...
                            CommunityTagKeyDTO, CommunityTagValueDTO)
...
class CommunityService:
    ...
    @classmethod
    def get_available_community_tags(cls, spaces_filter: List[str],
                                     key_filter: str, label_filter: str, personal_only: bool, page: int,
                                     number_of_items_per_page: int) -> PageDTO[CommunityTagKeyDTO]:
        if cls.community_api_url is None:
            return None
        ...
        try:
            response = ExternalApiService.post(
                url,
                {'technicalNameFilter': key_filter, 'labelFilter': label_filter, 'spacesFilter': spaces_filter,
    ...
    def get_community_tag_values(
            cls, community_tag_key: str, page: int, number_of_items_per_page: int) -> PageDTO[CommunityTagValueDTO]:
        if cls.community_api_url is None:
            return None
