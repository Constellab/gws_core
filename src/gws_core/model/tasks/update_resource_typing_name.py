...
@task_decorator(
    "UpdateResourceTypingName",
    human_name="[Support] Update resource typing name",
    ...
    config_specs = ConfigSpecs(
        {
            ...
            "resources": ParamSet(
                ConfigSpecs(
                    {
                        "old_name": StrParam(
                            human_name="Old resource typing name",
                            short_description="Ex: RESOURCE.gws_core.MyOldTaskUniqueName",
                        ),
                        "new_name": StrParam(
                            human_name="New resource typing name",
                            short_description="Ex: RESOURCE.gws_core.MyNewTaskUniqueName",
                        ),
                    }
                ),
        ...
        for resource in resources:
            ...
            try:
                ...
                self.log_error_message(
                    f"Error while updating resource typing name '{old_name}' to '{new_name}'"
                )
