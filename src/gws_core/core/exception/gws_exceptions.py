...
class GWSException(Enum):
    ...
    REPORT_ADD_EXP_OTHER_PROJECT = "Can't link the experiment to the note because they are in different projects"
    ...
    DELETE_PROJECT_WITH_REPORTS = "The project can't be deleted because it contains synced notes"
