...
class GWSException(Enum):
    ...
    REPORT_VALIDATED = "The note can't be updated not delete because it is validated"
    REPORT_EXP_ALREADY_LINKED = "The experiment is already linked with the note"
    REPORT_VALIDATION_EXP_NOT_VALIDATED = "The linked experiment '{{title}}' must be validated first"
    REPORT_VALIDATION_EXP_OTHER_FOLDER = "The linked experiment '{{title}}' is associated to another folder"
    REPORT_VALIDATION_RESOURCE_GENERATED_VIEW_OTHER_EXP = "The view '{{view_name}}' is from the experiment '{{exp_title}}' but this experiment is not linked to the note. Please link this experiment to the note."
    REPORT_VALIDATION_RESOURCE_UPLOADED_VIEW_OTHER_EXP = "The view '{{view_name}}' is from the resource '{{resource_name}}' but this resource is not used by any of the related experiment of the note."
    REPORT_ADD_EXP_OTHER_FOLDER = "Can't link the experiment to the note because they are in different folders"
    REPORT_HAS_A_VIEW_FROM_EXPERIMENT = "Can't dissociate the experiment from the note because the note has a view of a resource that was generated by the experiment"
    ...
    REPORT_NO_LINKED_EXPERIMENT = "The note is not linked with an experiment. Please link it to an experiment to access views."
    DELETE_FOLDER_WITH_EXPERIMENTS = "The folder can't be deleted because it contains synced experiments"
    DELETE_FOLDER_WITH_REPORTS = "The folder can't be deleted because it contains synced notes"
    ...
    RESET_ERROR_EXP_LINKED_TO_A_REPORT = "Can't reset the experiment because one of the output resource is used in note '<a href=\"{{report_url}}\" target=\"_blank\">{{report}}</a>'"
