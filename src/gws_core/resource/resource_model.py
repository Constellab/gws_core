...
class ResourceModel(ModelWithUser, ModelWithFolder, NavigableEntity):
    ...
    # true when the resource is UPLOADED or is an scenario output
    flagged: bool = BooleanField(default=False)

    # provided when the resource is generated by an scenario, this contains the port name of the task that generated it
