...
class ResourceModel(ModelWithUser, ModelWithFolder, NavigableEntity):
    ...
    scenario: Scenario | None = DeferredForeignKey("Scenario", null=True, index=True)
    folder: SpaceFolder | None = ForeignKeyField(SpaceFolder, null=True, index=True)
    task_model: TaskModel | None = DeferredForeignKey("TaskModel", null=True, index=True)
    ...
    parent_resource_id: str | None = ForeignKeyField("self", null=True, index=True, lazy_load=False)

    name: str = CharField(null=False)

    fs_node_model: FSNodeModel | None = ForeignKeyField(
    ...
    generated_by_port_name: str | None = CharField(null=True)

    brick_version: str = CharField(null=False, max_length=50, default="")
