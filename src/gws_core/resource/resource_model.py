...
class ResourceModel(ModelWithUser, ModelWithFolder, NavigableEntity):
    ...
    folder = NullableForeignKeyField(SpaceFolder, index=True)
    ...
    parent_resource_id = NullableForeignKeyIdField("self", index=True)
    ...
    generated_by_port_name = NullableCharField()
