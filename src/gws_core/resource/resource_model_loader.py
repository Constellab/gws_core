...
class ResourceModelLoader:
    ...
    def load_resource_model(
        ...
        self.update_resource_model(resource_model, origin, message_dispatcher)
    ...
    def update_resource_model(
        ...
        resolved_scenario, resolved_task_model = self._resolve_scenario_and_task(message_dispatcher)
