...
from ..core.classes.search_builder import SearchBuilder, SearchFilterCriteria, SearchParams
...
class ResourceService:
    ...
    def update_folder(cls, resource_id: str, folder_id: str | None) -> ResourceModel:
        ...
        folder: SpaceFolder = SpaceFolder.get_by_id_and_check(folder_id) if folder_id else None
    ...
    def call_view_on_resource_model(
        ...
        return CallViewResult(
            view_dto, resource_model.id, view_config, view_title, view.get_type(), style
        )
