...
class SendResourceToLab(Task):
    ...
    config_specs: ConfigSpecs = {
        ...
        'create_option': ResourceDownloaderHttp.config_specs['create_option'],
    ...
    @classmethod
    def build_config(cls, credentials: CredentialsDataLab | str, link_duration: int,
                     create_option: ResourceDownloaderCreateOption) -> ConfigParamsDict:
        return ConfigParams({
