...
from ..technical_info import TechnicalInfoDict
...
class AnyView(View):
    ...
    def __init__(self, view_json: dict):
        ...
        super().__init__()
        self._view_data_json = view_json.get("data") or {}
        self.set_technical_info_dict(
            TechnicalInfoDict.deserialize(view_json.get("technical_info") or [])
        )
