...
def get_logs_status(_=Depends(AuthService.check_user_access_token)) -> LogsStatus:
...
def get_log_complete_info(log_file_name: str, _=Depends(AuthService.check_user_access_token)):
