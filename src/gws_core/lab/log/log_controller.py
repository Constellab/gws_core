...
def get_log_complete_info(log_file_name: str, _=Depends(AuthorizationService.check_user_access_token)) -> LogCompleteInfoDTO:
...
def download_log(log_file_name: str, _=Depends(AuthorizationService.check_user_access_token)) -> FileResponse:
...
def download_log_json(log_file_name: str, _=Depends(AuthorizationService.check_user_access_token)) -> StreamingResponse:
