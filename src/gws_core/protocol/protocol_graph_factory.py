...
class ProtocolGraphFactory:
    ...
    def _create_protocol_model_from_graph_recur(
        self, protocol: ProtocolModel, graph: ProtocolGraphConfigDTO
    ) -> ProtocolModel:
        """
        ...
        protocol.init_connectors_from_graph(
            graph.links, check_compatiblity=self.check_connector_compatiblity
        )
