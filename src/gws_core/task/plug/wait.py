...
@task_decorator(
    unique_name="Wait",
    short_description="Wait a number of seconds specified in the config",
...
class Wait(Task):
    ...
    config_specs = ConfigSpecs(
        {
            "waiting_time": FloatParam(
                default_value=3,
                min_value=0,
                short_description="The waiting time in seconds. Defaults to 3 second.",
            )
        }
    )
