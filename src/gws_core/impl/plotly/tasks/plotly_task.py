...
@task_decorator(
    "PlotlyTask", human_name="Task Plotly", short_description="General Plotly Task", hide=True
)
class PlotlyTask(Task):
    ...
    output_specs = OutputSpecs(
        {"output_plot": OutputSpec(PlotlyResource, human_name="Plotly figure")}
    )
    config_specs_facet = {
        # facet params
        "facet_row": StrParam(
    ...
    layout = {
        ...
        "category_orders": StrParam(
            default_value=None, optional=True, human_name="category orders", visibility="private"
        ),
        "log_x": BoolParam(
            default_value=False,
            optional=True,
    ...
    pattern_shape = {  # bar, histogram
        "pattern_shape": StrParam(
            default_value=None, optional=True, human_name="pattern shape", visibility="private"
        ),
        ...
        "pattern_shape_map": StrParam(
            default_value=None, optional=True, human_name="pattern shape map", visibility="private"
        ),
    }
    color_continuous = {  # bar, scatter
        ...
        "range_color": ListParam(
            default_value=None, optional=True, human_name="range colors", visibility="private"
        ),
    }
    symbol = {  # scatter, line
        "symbol": StrParam(
        ...
        "symbol_sequence": StrParam(
            default_value=None, optional=True, human_name="symbol sequence", visibility="private"
        ),
        "symbol_map": StrParam(
