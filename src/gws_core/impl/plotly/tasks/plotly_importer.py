...
from gws_core.task.converter.exporter import ResourceExporter, exporter_decorator
from gws_core.task.converter.importer import ResourceImporter, importer_decorator


@importer_decorator(
    unique_name="PlotlyImporter",
    target_type=PlotlyResource,
...
@exporter_decorator(
    unique_name="PlotlyExporter",
    source_type=PlotlyResource,
