...
def run_astro_travel_scenario(_=Depends(AuthService.check_user_access_token)) -> ScenarioDTO:
    """
...
def run_astro_super_travel_scenario(_=Depends(AuthService.check_user_access_token)) -> ScenarioDTO:
    """
    Run astrobot scenario.
    """
