...
import gws_streamlit_main as StreamlitAuthenticateUser
...
def _render_streamlit_state():
    def example_demo():
        user = StreamlitMainState.get_current_user()
...
user = StreamlitAppState.get_current_user()
...
if user:
    ...
    example_tabs(
        ...
        doc_func=StreamlitMainState.get_current_user,
    )


def _render_hide_sidebar_toggle():
    code = """from gws_streamlit_main import StreamlitHelper
