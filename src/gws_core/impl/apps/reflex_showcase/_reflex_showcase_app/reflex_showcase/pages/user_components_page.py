...
def user_components_page() -> rx.Component:
    ...
    example1_component = rx.vstack(
        ...
        rx.hstack(
            user_profile_picture(fake_users[0], size="normal"),
            user_profile_picture(fake_users[1], size="normal"),
            user_profile_picture(fake_users[2], size="normal"),
            spacing="4",
        ),
        rx.heading("Small Size", size="4", margin_top="1em", margin_bottom="0.5em"),
        rx.hstack(
            user_profile_picture(fake_users[0], size="small"),
            user_profile_picture(fake_users[1], size="small"),
            user_profile_picture(fake_users[2], size="small"),
            spacing="4",
        ),
        align="start",
    )
...
user_profile_picture(user, size="small")   # 24px"""
    ...
    example2_component = rx.vstack(
        rx.heading("Normal Size", size="4", margin_bottom="0.5em"),
        rx.vstack(
            user_inline_component(fake_users[0], size="normal"),
            user_inline_component(fake_users[1], size="normal"),
            user_inline_component(fake_users[2], size="normal"),
            spacing="3",
            align="start",
        ),
        rx.heading("Small Size", size="4", margin_top="1em", margin_bottom="0.5em"),
        rx.vstack(
            user_inline_component(fake_users[0], size="small"),
            user_inline_component(fake_users[1], size="small"),
            user_inline_component(fake_users[2], size="small"),
            spacing="3",
            align="start",
        ),
        align="start",
