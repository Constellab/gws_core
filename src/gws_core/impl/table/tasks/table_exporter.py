    ...
    config_specs = ConfigSpecs(
        {
            ...
            "write_header": BoolParam(
                default_value=True,
                visibility=BoolParam.PROTECTED_VISIBILITY,
                human_name="Write header",
                short_description="Set True to write column names (header), False otherwise",
            ),
            "write_index": BoolParam(
                default_value=False,
                visibility=BoolParam.PROTECTED_VISIBILITY,
                human_name="Write index",
                short_description="Set True to write row names (index), False otherwise",
            ),
        }
    )
