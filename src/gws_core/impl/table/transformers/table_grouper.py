...
from ....config.param_spec import (BoolParam, IntParam, ListParam, ParamSet,
                                   StrParam)
...
@task_decorator(unique_name="TableGrouper", short_description="Group table columns according to column keys")
class TableGrouper(Task):
    ...
    config_specs: ConfigSpecs = {
        "grouping_key": StrParam(
            ...
            short_description="The key used to groupe the columns of the table. Only for {key,value} annotated data. See also AnnotatedTable.",
        )
    }
