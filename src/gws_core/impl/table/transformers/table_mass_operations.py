...
class TableColumnMassOperations(Task):
    ...
    **Only works if  ```Error on unknown column``` is checked**
    ...
    input_specs: InputSpecs = InputSpecs(
        {
            "table": InputSpec(
                Table,
                human_name="Input table",
                short_description="Table that contains the data to apply operations on",
            ),
            "operation_table": InputSpec(
                Table,
                human_name="Operation table",
    ...
    config_specs = ConfigSpecs(
        {
            "name_column": StrParam(
                optional=True,
                human_name="Name column",
            ...
            "calculations_column": StrParam(
                optional=True,
                human_name="Calculations column",
