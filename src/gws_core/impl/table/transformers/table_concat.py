...
class TableRowConcat(Task):
    ...
    config_specs = ConfigSpecs(
        {
            "column_tags_options": SelectParam(
                human_name="Column tags options",
                short_description="What to do with the column tags. See doc for more info",
                options=TableConcatHelper.OPPOSITE_TAG_OPTIONS,
...
class TableColumnConcat(Task):
    ...
    config_specs = ConfigSpecs(
        {
            "row_tags_options": SelectParam(
                human_name="Row tags options",
