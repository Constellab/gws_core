...
class SmartTaskBase(Task):
    ...
    PY_INTRO = "You are a developer assistant that generate code in python."
    R_INTRO = "You are a developer assistant that generate code in R."
    VAR_INPUTS = "$INPUTS$"
    VAR_OUTPUTS = "$OUTPUTS$"
    ...
    def build_main_context(self, params: ConfigParams, task_inputs: TaskInputs,
        ...
        This context follow the context introduction : 'You are a developer assistant that generate code in python.'
        Exemple of main context : 'The code purpose is to generate a graph from a dataframe using matplotlib.'
    ...
    def build_context(self, params: ConfigParams, task_inputs: TaskInputs,
        ...
        This method can be overrided to change the way of describing the context.
        Here is the structure of the context :
        - Introduction
        - Main context
        - Inputs context
        - Outputs context
