...
@core_app.get(
    "/rich-text/{object_type}/{object_id}/image/{filename}",
    tags=["Rich text"],
...
@core_app.get(
    "/rich-text/{object_type}/{object_id}/file-view/{filename}",
    tags=["Rich text"],
...
########################################### FILE ###########################################
@core_app.post(
    "/rich-text/{object_type}/{object_id}/file",
    tags=["Rich text"],
    summary="Upload a file to a rich text",
)
def upload_file(
    object_type: RichTextObjectType,
    object_id: str,
...
@core_app.get(
    "/rich-text/{object_type}/{object_id}/file/{filename}",
    tags=["Rich text"],
...
@core_app.post(
    "/rich-text/transcribe-audio", tags=["Rich text"], summary="Transcribe audio file to rich text"
)
