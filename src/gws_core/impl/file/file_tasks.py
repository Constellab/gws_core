...
@task_decorator(
    unique_name="FsNodeExtractor",
    human_name="Fs node extractor",
...
class FsNodeExtractor(Task):
    ...
    config_specs = ConfigSpecs(
        {
            "fs_node_path": StrParam(
                human_name="Sub path for the FSNode to extract",
                short_description="Path to the sub file or folder to extract",
            ),
            "fs_node_typing_name": StrParam(
                human_name="FSNode typing name",
