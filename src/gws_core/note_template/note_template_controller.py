...
def create_empty(data: CreateNoteTemplateDTO, _=Depends(AuthorizationService.check_user_access_token)) -> NoteTemplateDTO:
...
def create_from_note(
        data: CreateNoteTemplateFromNoteDTO, _=Depends(AuthorizationService.check_user_access_token)) -> NoteTemplateDTO:
...
def update_title(doc_id: str,
                 ...
                 _=Depends(AuthorizationService.check_user_access_token)) -> NoteTemplateDTO:
...
def update_content(
        doc_id: str, content: RichTextDTO, _=Depends(AuthorizationService.check_user_access_token)) -> RichTextDTO:
...
def search(search_dict: SearchParams,
           ...
           _=Depends(AuthorizationService.check_user_access_token)) -> PageDTO[NoteTemplateDTO]:
    """
