...
from gws_core.note_template.task.note_template_resource import NoteTemplateResource
...
class SelectNoteTemplate(Task):
    ...
    def run(self, params: ConfigParams, inputs: TaskInputs) -> TaskOutputs:
        ...
        return {"note_template": NoteTemplateResource(note_template_id=note_template.id)}
