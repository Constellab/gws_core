...
class FormTemplateVersion(ModelWithUser):
    ...
    content = NullableJSONField(null=True)

    published_at = NullableDateTimeUTC(null=True)
    published_by = NullableForeignKeyField(User, null=True, backref="+")
