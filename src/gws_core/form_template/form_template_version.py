...
class FormTemplateVersion(ModelWithUser):
    ...
    template: TypedForeignKeyField[FormTemplate] = TypedForeignKeyField(
    ...
    status: TypedEnumField[FormTemplateVersionStatus] = TypedEnumField(
    ...
    content: NullableJSONField = NullableJSONField()

    published_at: NullableDateTimeUTC = NullableDateTimeUTC()
    published_by: NullableForeignKeyField[User] = NullableForeignKeyField(User, backref="+")
