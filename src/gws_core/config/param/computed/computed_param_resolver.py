...
class ComputedParamResolver:
    ...
    def compute_all(
        ...
        outer_scope: dict[str, Any] = {
            ...
            if k in specs.specs and not isinstance(specs.specs[k], ComputedParam)
        }
        ...
        while pending_outer or pending_inner:
            ...
            for key in list(pending_outer):
                ...
                same_refs = ConfigSpecsEvaluator.extract_referenced_keys(expr)
            ...
            for psk_ik in list(pending_inner):
                ...
                outer_refs = ConfigSpecsEvaluator.extract_referenced_outer_keys(expr)
                ...
                blocked = False
                for r in same_refs:
                    if r != ik and (psk, r) in pending_inner:
                        blocked = True
                        break
                if blocked:
                    continue
