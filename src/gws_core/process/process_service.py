...
class ProcessService:
    ...
    @classmethod
    def get_logs_of_process(cls, process_type: ProcessType, process_id: str) -> LogsBetweenDatesResponse:
        ...
        start_date = process_model.started_at
        end_date = process_model.ended_at or DateHelper.now_utc()

        # retrieve the log generated by the process during the time
        return LogService.get_logs_between_dates(start_date, end_date, from_experiment=True)
