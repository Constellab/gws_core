...
def get_scenario_template_graph(id_: str,
                                _=Depends(AuthorizationService.check_user_access_token)) -> ProtocolGraphConfigDTO:
...
def search(search_dict: SearchParams,
           ...
           _=Depends(AuthorizationService.check_user_access_token)) -> PageDTO[ScenarioTemplateDTO]:
    """
