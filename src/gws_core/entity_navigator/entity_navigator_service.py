...
class EntityNavigatorService:
    ...
    It is used to reset or delete an scenario, a resource or a process of a protocol
    """
    ...
    def _calculate_scenario_reset_impact(cls, scenario: Scenario) -> ImpactResult:
        """Method to calculate the impact of the reset of an scenario.
    ...
    def check_impact_delete_resource(cls, resource_id: str) -> ImpactResult:
        ...
        # If the resource was generated by an scenario, reset the scenario
