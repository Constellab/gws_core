...
from ._oauth2_space_header_scheme import space_api_key_header, space_header_api_user_header
...
class AuthSpace:
    ...
    @classmethod
    def check_space_api_key_and_user(
        cls,
        api_key: str = Depends(space_api_key_header),
        user_id: str = Depends(space_header_api_user_header),
    ) -> None:
