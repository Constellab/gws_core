...
class ScenarioService():
    ...
    def create_scenario_from_dto(cls, scenario_dto: ScenarioSaveDTO) -> Scenario:
        ...
        scenario_component: ScenarioComponent = None
        if scenario_dto.scenario_component_id:
            scenario_component = ScenarioComponent.get_by_id_and_check(
                scenario_dto.scenario_component_id)
        elif scenario_dto.scenario_component_json and isinstance(scenario_dto.scenario_component_json, dict):
            scenario_component = ScenarioComponentFactory.from_export_dto_dict(
                scenario_dto.scenario_component_json)
    ...
    def create_scenario(cls, folder_id: str = None, title: str = "",
        ...
        if scenario_component is not None:
            description = scenario_component.description
            protocol_model = ProtocolService.create_protocol_model_from_template(scenario_component)
        else:
