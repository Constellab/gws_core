...
from .credentials_type import CredentialsDataSpecsDTO, CredentialsDTO, SaveCredentialsDTO


@core_app.post("/credentials")
def create_credentials(
    credentials: SaveCredentialsDTO, _=Depends(AuthorizationService.check_user_access_token)
) -> CredentialsDTO:
...
def delete_credentials(id_: str, _=Depends(AuthorizationService.check_user_access_token)) -> None:
...
def get_credentials_by_name(
    name: str, _=Depends(AuthorizationService.check_user_access_token)
) -> Optional[CredentialsDTO]:
...
def get_credentials_data_specs(
    _=Depends(AuthorizationService.check_user_access_token),
