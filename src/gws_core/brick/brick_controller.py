...
def get_bricks_status(_=Depends(AuthorizationService.check_user_access_token_or_app)) -> List[BrickDTO]:
...
def get_brick_info(brick_name: str, _=Depends(AuthorizationService.check_user_access_token)) -> Optional[BrickDTO]:
...
def get_brick_migration_versions(brick_name: str,
                                 _=Depends(AuthorizationService.check_user_access_token)) -> List[MigrationDTO]:
