...
from gws_core.apps.app_dto import AppInstanceConfigDTO, AppInstanceDTO, AppInstanceUrl, AppType
...
class AppInstance:
    ...
    def get_user_from_token(self, user_access_token: str) -> str | None:
    ...
    def get_app_full_url(self, host_url: str, token: str) -> AppInstanceUrl:
        ...
        params = {"gws_token": token, "gws_app_id": self.resource_model_id}
    ...
    def _generate_config_dev_mode(self) -> None:
        ...
        with open(self._dev_config_file, encoding="utf-8") as file_path:
