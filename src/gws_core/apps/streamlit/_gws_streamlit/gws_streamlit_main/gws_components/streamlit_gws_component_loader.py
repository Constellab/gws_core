...
from gws_streamlit_base import StreamlitHelper
...
from ..gws_streamlit_main_state import StreamlitUserAuthInfo
...
class StreamlitComponentLoader:
    ...
    def call_component(
        self, data: Any, key: str, authentication_info: StreamlitUserAuthInfo | None = None
    ) -> Any:
        ...
        :type key: str
        :param authentication_info: authentication info to pass to the component if the component can request the API, defaults to None
        :type authentication_info: StreamlitUserAuthInfo | None, optional
        :return: _description_
        :rtype: Any
        """
