...
class StreamlitMenuButton:
    ...
    _buttons: list[StreamlitMenuButtonItem]
    ...
    def render(
        self, icon: str = "more_vert", disabled: bool = False
    ) -> StreamlitMenuButtonItem | None:
        ...
        previous_click: StreamlitMenuButtonValue = cast(
            StreamlitMenuButtonValue, st.session_state.get(previous_click_key)
        )
