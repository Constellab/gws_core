...
def generate(
        ...
        human_name: Annotated[str, typer.Option("--human-name", help="Human-readable name of the task.")] = None,
        short_description:
        Annotated[str, typer.Option("--short-description", help="Short description of what the task does.")] = None):
