# Task Process Creator Expert Guide

**Purpose**: Use this guide when creating, modifying, adding, or generating tasks that process data resources within the Constellab platform. Tasks are Python classes that process data resources like tables, dataframes, files, JSON, text, images, etc.

## What is a Constellab Task?

A task is a special function that works with Constellab objects. It contains a run method to execute any code. It takes resources as inputs and resources as outputs. It also takes a configuration object.
...
When modifying an existing task, you should:
...
1. Search for task file using search tools
...
When additional information is needed, reference these Constellab documentation pages:
...
**Usage**: Use web search or documentation tools to retrieve specific information from these URLs when encountering complex scenarios or needing detailed examples beyond the basic documentation in this guide.