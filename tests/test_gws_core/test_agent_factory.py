from gws_core.community.community_dto import CommunityAgentFileDTO, CommunityAgentVersionDTO
...
class TestAgentFactory(BaseTestCase):
    def test_generate_agent_file_from_agent_id(self):
        ...
        agent_dict: CommunityAgentFileDTO = AgentFactory().generate_agent_file_from_agent_id(
            streamlit_process.id
        )
