...
class TestStringHelper(TestCase):
    def test_camel_to_sentence(self):
        ...
        self.assertEqual(
            StringHelper.camel_case_to_sentence("TestClass2Build"), "Test class2 build"
        )
        self.assertEqual(
            StringHelper.camel_case_to_sentence("TestClass2 Build"), "Test class2 build"
        )
    ...
    def test_to_snake_case(self):
        self.assertEqual(
            StringHelper.to_snake_case("TestClass2_Build one"), "test_class2_build_one"
        )
