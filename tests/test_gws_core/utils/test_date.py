...
class TestDate(TestCase):
    ...
    def test_pretty_date(self):
        ...
        self.assertEqual(
            DateHelper.get_duration_pretty_text(duration_in_seconds), "1 mins, 58 secs"
        )
        ...
        self.assertEqual(
            DateHelper.get_duration_pretty_text(duration_in_seconds), "1 hours, 2 mins"
        )
        ...
        self.assertEqual(
            DateHelper.get_duration_pretty_text(duration_in_seconds), "2 days, 2 hours"
        )
