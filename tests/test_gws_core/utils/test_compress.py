...
from gws_core import Compress, GzipCompress, Settings, TarCompress, TarGzCompress, ZipCompress
...
class TestCompress(TestCase):
    def test_zip_unzip(self):
        ...
        self.assertTrue(
            FileHelper.exists_on_os(os.path.join(destination_folder, "to_zip", "test.json"))
        )
    ...
    def test_gz(self):
        ...
        self.assertTrue(FileHelper.exists_on_os(destination_folder))
        self.assertTrue(FileHelper.exists_on_os(os.path.join(destination_folder, "zipped.txt")))
