...
class TestTagPropagation(BaseTestCase):
    def test_tag_propagation_exp(self):
        ...
        self.assertTrue(
            output_tag_a.origins.has_origin(
                TagOriginType.TASK_PROPAGATED, tag_robot._process_model.id
            )
        )
        ...
        # Check task tags
        ouput_tag_task_propagable = first_output.tags.get_tag(
        ...
        self.assertTrue(
            ouput_tag_task_propagable.origins.has_origin(
                TagOriginType.TASK, tag_robot._process_model.id
            )
        )

        ouput_tag_task_not_propagable = first_output.tags.get_tag(
        ...
        self.assertTrue(
            ouput_tag_task_not_propagable.origins.has_origin(
                TagOriginType.TASK, tag_robot._process_model.id
            )
        )
