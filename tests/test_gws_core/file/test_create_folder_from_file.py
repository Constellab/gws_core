...
class TestCreateFolderFromFile(BaseTestCaseLight):
    ...
    def test_create_folder_from_file(self):
        ...
        file_1_path = FileHelper.create_empty_file_if_not_exist(os.path.join(temp_dir, 'test_file.txt'))
        ...
        task_runner = TaskRunner(CreateFolderFromFiles,
                                 params={'folder_name': 'new_folder',
                                         'filenames': [
                                             {'filename': ''},
                                             {'filename': 'new_folder'},
                                         ]},
                                 inputs={'resource_1': file,
                                         'resource_2': folder
                                         },
        ...
        self.assertTrue(FileHelper.exists_on_os(os.path.join(folder_result.path, 'new_folder', 'sub_file.txt')))
