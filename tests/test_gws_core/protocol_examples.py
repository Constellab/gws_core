...
@task_decorator(unique_name="RobotWaitFood", human_name="Wait food", short_description="Wait food")
...
@task_decorator(
    unique_name="RobotEmptyFood", human_name="Empty food", short_description="Empty food"
)
