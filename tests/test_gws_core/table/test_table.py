...
class TestTable(TestCase):
    ...
    def test_table_select(self):
        ...
        column_tags = [{"lg": "EN", "c": "UK"}, {"lg": "PT", "c": "PT"}, {"lg": "CH", "c": "CH"}]
        ...
        self.assertEqual(
            sub_table.get_column_tags(),
            [{"lg": "EN", "c": "UK"}, {"lg": "PT", "c": "PT"}, {"lg": "CH", "c": "CH"}],
        )
        ...
        self.assertEqual(
            sub_table.get_column_tags(), [{"lg": "EN", "c": "UK"}, {"lg": "CH", "c": "CH"}]
        )
