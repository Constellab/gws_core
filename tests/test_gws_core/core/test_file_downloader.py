...
class TestFileDownloader(TestCase):
    def test_download(self):
        ...
        file_path = file_downloader.download_file_if_missing(url, filename, timeout=60)
    ...
    def test_task_file_downloader(self):
        ...
        url = "https://storage.gra.cloud.ovh.net/v1/AUTH_a0286631d7b24afba3f3cdebed2992aa/opendata/gws_core/iris.csv"
        task_file_downloader.download_file_if_missing(url, "my_file.pdf", timeout=60)
    ...
    def test_file_zip_downloader(self):
        ...
        self.assertEqual(os.path.join(destination_folder, folder_name), folder_path)
