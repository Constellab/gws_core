...
class TestS3Server(BaseTestCase):
    ...
    def test_datahub_s3(self):
        ...
        try:
            ...
            self._test_auth(
                self.DATAHUB_ACCESS_KEY_ID,
                self.DATAHUB_SECRET_KEY,
    ...
    def _test_datahub_s3(self, folder_id: str):
        ...
        result = s3_client.list_objects_v2(
            Bucket=DataHubS3ServerService.FOLDERS_BUCKET_NAME, Prefix=prefix
        )
        ...
        s3_client.download_file(
            Bucket=DataHubS3ServerService.FOLDERS_BUCKET_NAME, Key=key, Filename=file_path
        )
    ...
    def _create_lab_s3_server_credentials(self, bucket_path: str) -> Credentials:
