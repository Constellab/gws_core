...
class TestControllerHTTP(unittest.TestCase):
    ...
    def test_get_model(self):
        ...
        vm = Controller.action("get", html_vmodel.uri)
    ...
    def test_put_model(self):
        ...
        vm = Controller.action("put", json_vmodel.uri, data)
    ...
    def test_post_model(self):
        ...
        data = { 
            ...
            "type" : "tests-test-controller-jsonpersonviewmodel"
        }
        new_json_view = Controller.action("post", html_vmodel.uri, data)
    ...
    def test_post_model_raise_error(self):
        ...
        self.assertRaises(Exception, Controller.action, "post", bill.uri, data)
    ...
    def test_delete_model(self):
        ...
        self.assertRaises(Exception, Controller.action, "delete", elon.uri)
        vmodel = Controller.action("delete", html_vmodel.uri)
