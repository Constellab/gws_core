...
class TestTableAggregator(TestCase):
    def test_table_aggregator_helper(self):
        ...
        dataframe = DataframeAggregatorHelper.aggregate(data=initial_df, direction="vertical", func="sum")
        ...
        # Horizontal
        dataframe = DataframeAggregatorHelper.aggregate(data=initial_df, direction="horizontal", func="sum")
